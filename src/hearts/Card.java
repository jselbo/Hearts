...
/**
 * Represents a single playing card that can be found in a standard deck of playing cards. 
 * It can hold a value of 2-10, Jack, Queen, King, or Ace with a suit of Club, Spade, Diamond, or Heart.
 * 
 * @author Joshua
 * 
 */
public class Card extends GameElement
{
    ...
    public Card(int value, int suit)
    {
        ...
        upImage = new ImageIcon("images/" + Integer.toString(value) + s + ".png").getImage();
